    ...
    <script type="text/javascript">
        ...
        layui.use([ 'jquery', 'layer', 'form', 'table','laydate'  ], function() {
            ...
            tableIns=table.render({
                ...
                ,url:'${ctx}/log-login/loadAllLogLogin' //数据接口
            ...
            $("#doSearch").click(function(){
                ...
                tableIns.reload({
                    url:"${ctx}/log-login/loadAllLogLogin?"+params
                })
            });
            ...
            table.on('tool(logInfoTable)', function(obj){
                ...
                if(layEvent === 'del'){ //删除
                    layer.confirm('真的删除【'+data.loginname+'】这个日志吗', function(index){
                        //向服务端发送删除指令
                        $.post("${ctx}/log-login/deleteLogLogin",{id:data.id},function(res){
                            layer.msg(res.msg);
                            //刷新数据 表格
                            tableIns.reload();
                        })
            ...
            function deleteBatch(){
                ...
                if (params == ""){
                    layer.confirm('请先选择要删除的用户',{icon: '&#xe60b;', title:'提示'},function(index){
                        layer.close(index);
                    });
                }else {
                    layer.confirm('真的删除选中的这些日志吗', function(index){
                        //向服务端发送删除指令
                        $.post("${ctx}/log-login/deleteBatchLogLogin",params,function(res){
                            layer.msg(res.msg);
                            //刷新数据 表格
                            tableIns.reload();
                        })
